 ...
 *
 * IR generator: For pp4 you are adding "Emit" behavior to the ast
 * node classes. Your generator should do an inorder walk on the
 * parse tree, and when visiting each node, emit LLVM IR instructions
 * from that node.
 */
