...
typedef enum { 
    ...
    T_Const, T_Uniform, T_Layout, T_Continue, T_Do,
    T_Switch, T_Case, T_Default, T_In, T_Out, T_InOut, 
    T_Mat2, T_Mat3, T_Mat4, T_Vec2, T_Vec3, T_Vec4,
    T_IVec2, T_IVec3, T_IVec4, T_BVec2, T_BVec3, T_BVec4, 
    T_UVec2, T_UVec3, T_UVec4, T_UInt, T_Struct, T_Identifier,
    T_Inc, T_Dec,
    T_NumTokenTypes
} TokenType;
